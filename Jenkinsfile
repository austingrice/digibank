pipeline {
  ...
  environment {
    // You know the drill. Please change teamxx to your team. If you were teamxx you would do: team = 'teamxx' 
    // The line below is the only line you need to change and teamxx is the only piece of that line to change.
    team = 'teamxx'
